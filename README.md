...
Typescript browser application template based on
[Create React App](https://github.com/facebook/create-react-app)
for most of the initial files, and [nave](https://github.com/isaacs/nave)
for the node virtual environment.
...
This application uses the software packages indicated in `yarn.lock` (see
individual packages for license terms), and also uses the following
resources:

* Application icon: https://iconmonstr.com/weather-8-svg/ [[license]](https://iconmonstr.com/license/)
